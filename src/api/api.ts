...
export const RepositoryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @summary Get all repositories assigned to the provided team
         * @param {string} teamId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllAssignedRepositories: async (teamId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'teamId' is not null or undefined
            assertParamExists('getAllAssignedRepositories', 'teamId', teamId)
            const localVarPath = `/api/repo/repositories/{teamId}`
                .replace(`{${"teamId"}}`, encodeURIComponent(String(teamId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const RepositoryApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllAssignedRepositories(teamId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RepositoryTO>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllAssignedRepositories(teamId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const RepositoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllAssignedRepositories(teamId: string, options?: any): AxiosPromise<Array<RepositoryTO>> {
            return localVarFp.getAllAssignedRepositories(teamId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all Repositories
...
export class RepositoryApi extends BaseAPI {
     ...
     * @memberof RepositoryApi
     */
    public getAllAssignedRepositories(teamId: string, options?: any) {
        return RepositoryApiFp(this.configuration).getAllAssignedRepositories(teamId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ShareApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @summary Get all teams that can access a specific artifact (Admin permissions required
         * @param {string} artifactId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
