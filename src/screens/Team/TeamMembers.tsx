...
import {AssignmentTORoleEnum, TeamAssignmentTO, TeamAssignmentTORoleEnum, UserInfoTO} from "../../api";
...
const TeamMembers: React.FC<Props> = props => {
    ...
    //TODO: role im UserListItem nur provisorisch hardgecodet
    return (
        <>
            <List dense={false}>
                ...
                <Paper>
                    ...
                    {users?.map(user => (
                        <UserListItem
                            ...
                            role={AssignmentTORoleEnum.Member}
